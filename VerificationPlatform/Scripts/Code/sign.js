$(function(){
    ...
    var nub4=0;
      ...
      //         obj[input[i].attr('name')]=input[i].value;
      //     }
      ...
      btn.on("click",function(){
      	if(nub==0||nub1==0||nub2==0||nub3==0||nub4==0){
           ...
           $.ajax({
              ...
              data:obj,
              datatype:"text",
              url:"http://192.168.87.160:8080/api/Account/Register",
              success:function(val){
              	   console.log(val);
              	   // if(val==1){
                  //      alert("注册成功");
